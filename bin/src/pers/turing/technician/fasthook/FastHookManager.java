...
//    private static final boolean DEBUG = BuildConfig.DEBUG;
    ...
    public static void doHook(String className,
                              ClassLoader classLoader,
                              String methodName,
                              String methodSig,
                              FastHookCallback callback, int mode, boolean jitInline) {
        ...
        Logd("doHook paramType: " + paramType);
    ...
    private static void doHook(Member targetMethod,
                               Member hookMethod,
                               Member forwardMethod,
                               Class[] paramType,
                               FastHookCallback callback,
                               int mode,
                               int retryCount) {
                        ...
                        switch (jitState) {
                            ...
                            case JIT_COMPILE:
                                ...
                                if(success) {
                                    ...
                                    if(Build.VERSION.SDK_INT >= ANDROID_O && DEBUG) {
